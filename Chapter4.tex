...
\begin{figure}[htbp]
	\centering
	\includegraphics[width=4.6in]{fig/matgen/matgen.eps}
...
\begin{figure}[htbp]
	\centering
	\subfloat[CPU strong scaling on Tianhe-2.]{\includegraphics[width=3.1in]{fig/matgen/cpu_th2_strong_scalable.eps}%
		\label{ss_tianhe}}
	\subfloat[CPU weak scaling on Tianhe-2.]{\includegraphics[width=3.1in]{fig/matgen/cpu_th2_weak_scalable.eps}%
		\label{ws_tianhe}}
...
\begin{figure*}[htbp]
	\centering
	\subfloat[CPU strong scaling on ROMEO.]{\includegraphics[width=3.1in]{fig/matgen/cpu_romeo_strong_scalable.eps}%
		\label{romeo}}
	\subfloat[CPU weak scaling on ROMEO.]{\includegraphics[width=3.1in]{fig/matgen/cpu_romeo_weak_scalable.eps}%
		\label{romeo_gpu}}
	\caption{Strong and weak scaling results of SMG2S on different platforms. A base 2 logarithmic scale is used for X-axis, and a base 10 logarithmic scale for Y-axis. }
...
\begin{figure*}[htbp]
	\centering
	\subfloat[GPU strong scaling on ROMEO.]{\includegraphics[width=3.1in]{fig/matgen/gpu_strong_scalable.eps}%
		\label{ss_romeo_gpu}}
	\subfloat[GPU weak scaling on ROMEO.]{\includegraphics[width=3.1in]{fig/matgen/gpu_weak_scalable.eps}%
		\label{ws_romeo_gpu}}
	\caption{Strong and weak scaling results of SMG2S on different platforms. A base 2 logarithmic scale is used for X-axis, and a base 10 logarithmic scale for Y-axis. }
