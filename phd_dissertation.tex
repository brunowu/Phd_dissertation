...
\usepackage[Bjornstrup]{fncychap}  %chapter styles
...
\begin{tabular}{>{\normalsize}l>{\normalsize}l>{\normalsize}l}
	&& \\
	Pr\'esident & Clarisse Dhaenens  &-  Universit\'e de Lille \\
	Rapporteurs &  Michel Dayd\'e &- Institut de Recherche en Informatique de Toulouse\\
	 &   &- ENSEEIHT\\
	 & \textcolor{red}{Not decided}  &- \\
	Examinateurs & Yutong Lu &- National Supercomputing Center in Guangzhou \\
	&&- Sun Yat-Sen University\\
	 & Mitsuhisa Sato & - RIKEN Center for Computational Science \\
		&&- Tuskuba University\\
	 & \textcolor{red}{A German ?} &-   \\
	Directeur & Serge G. Petiton &- Universit\'e de Lille \\
\end{tabular}
}
